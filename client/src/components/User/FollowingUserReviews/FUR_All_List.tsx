...
const FUR_All_List: React.FC<FUR_All_ListProps> = ({ review }) => {
            ...
            <div className="movie-info">
              ...
              {review.review.rating > 0 && (
                <div className="rating-div">
                  <FaStar size={15} color="gold" /> <span className="rating">{review.review.rating}/10</span>
                </div>
              )}
