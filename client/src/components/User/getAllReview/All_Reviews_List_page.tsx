...
const All_Reviews_List_page: React.FC<All_Review_ListProps> = ({ review }) => {
            ...
            <div className="all-review-movie-info">
              ...
              {review.rating > 0 && (
                <div className="rating-div">
                  <FaStar size={15} color="gold" /> <span className="review-rating">{review.rating}/10</span>
                </div>
              )}
...
export default All_Reviews_List_page;
